...
//     final List<String> statusFilter = ["Dalam proses", "Selesai", "Dibatalkan"];
//
...
//             ),
//           );
//         })..addAll(controller.selectedValueRiwayat.value == "Status" ? [
//           Padding(
//             padding: const EdgeInsets.only(right: 15),
//             child: DropdownButton<String>(
//               value: controller.selectedsStatus.value,
//               onChanged: (value) {
//                 controller.selectedsStatus.value = value!;
//               },
//               items: statusFilter.map((e) => DropdownMenuItem(child: Text(e), value: e)).toList(),
//             ),
//           )
//         ] : []),
//       )),
